...
import { PlusIcon, ArrowRightIcon, ShoppingBagIcon , XIcon , Trash2Icon } from "lucide-react";
    ...
    {items.length === 0 ? (
      ...
      <div key={item.product._id}className="flex gap-3 bg-app-cream/60 rounded-xl p-3" >
         ...
         <div className="flex-1 min-w-0">
           ...
           <p className="text-xs text-app-text-light">{currency}
           ...
           <div className="flex items-center justify-between mt-2">
              ...
              {/* increase the producct price by quantity */}
              <div className="flex items-center gap-2">
