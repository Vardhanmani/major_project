...
import { StarIcon , ArrowRightIcon , ShoppingCartIcon,LeafIcon ,MinusIcon ,PlusIcon} from "lucide-react";
            ...
            <div className="grid md:grid-cols-2 gap-0">
              ...
              <div className="relative flex-center p-8 md:p-12 min-h-[320px] md:min-h-[480px]">
                ...
                <div className="absolute top-5 left-5 flex flex-wrap gap-1.5">
                  ...
                  {product.discount > 0 && (
                    <span className="flex items-center gap-1 px-2.5 py-1 text-xs font-semibold bg-red-500 text-white rounded-full">
                ...
                {product.rating > 0 && (
                  <div className="flex items-center gap-2 mb-5">
                    <div className="flex items-center gap-0.5">
                      ...
                      <span className="text-sm fount-medium">{product.rating}</span>
